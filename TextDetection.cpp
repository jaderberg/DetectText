/*
    ...
    compile with:
g++ -o DetectText TextDetection.cpp FeaturesMain.cpp -lopencv_core -lopencv_highgui -lopencv_imgproc -I/Users/jaderberg/Desktop/DetectText -I/opt/local/include -L/opt/local/lib
*/
